...
#if RV32_HAS(BNRV_SIMD) && (defined(__SSSE3__) || defined(__ARM_NEON))
/* Use SIMD-optimized implementation */
#include "bnrv_simd.h"
#else
/* Scalar LUT fallback
 * LUT for BitNet: maps 8-bit weight patterns to 4 coefficients
 * Weight encoding: 00=0, 01=+1, 10=0, 11=-1
 */
/* clang-format off */
static const int8_t bitnet_lut[256][4] = {
    /* 0x00 */ { 0,  0,  0,  0}, /* 0x01 */ { 1,  0,  0,  0}, 
    /* 0x02 */ { 0,  0,  0,  0}, /* 0x03 */ {-1,  0,  0,  0}, 
    /* 0x04 */ { 0,  1,  0,  0}, /* 0x05 */ { 1,  1,  0,  0}, 
    /* 0x06 */ { 0,  1,  0,  0}, /* 0x07 */ {-1,  1,  0,  0}, 
    /* 0x08 */ { 0,  0,  0,  0}, /* 0x09 */ { 1,  0,  0,  0}, 
    /* 0x0a */ { 0,  0,  0,  0}, /* 0x0b */ {-1,  0,  0,  0}, 
    /* 0x0c */ { 0, -1,  0,  0}, /* 0x0d */ { 1, -1,  0,  0}, 
    /* 0x0e */ { 0, -1,  0,  0}, /* 0x0f */ {-1, -1,  0,  0}, 
    /* 0x10 */ { 0,  0,  1,  0}, /* 0x11 */ { 1,  0,  1,  0}, 
    /* 0x12 */ { 0,  0,  1,  0}, /* 0x13 */ {-1,  0,  1,  0}, 
    /* 0x14 */ { 0,  1,  1,  0}, /* 0x15 */ { 1,  1,  1,  0}, 
    /* 0x16 */ { 0,  1,  1,  0}, /* 0x17 */ {-1,  1,  1,  0}, 
    /* 0x18 */ { 0,  0,  1,  0}, /* 0x19 */ { 1,  0,  1,  0}, 
    /* 0x1a */ { 0,  0,  1,  0}, /* 0x1b */ {-1,  0,  1,  0}, 
    /* 0x1c */ { 0, -1,  1,  0}, /* 0x1d */ { 1, -1,  1,  0}, 
    /* 0x1e */ { 0, -1,  1,  0}, /* 0x1f */ {-1, -1,  1,  0}, 
    /* 0x20 */ { 0,  0,  0,  0}, /* 0x21 */ { 1,  0,  0,  0}, 
    /* 0x22 */ { 0,  0,  0,  0}, /* 0x23 */ {-1,  0,  0,  0}, 
    /* 0x24 */ { 0,  1,  0,  0}, /* 0x25 */ { 1,  1,  0,  0}, 
    /* 0x26 */ { 0,  1,  0,  0}, /* 0x27 */ {-1,  1,  0,  0}, 
    /* 0x28 */ { 0,  0,  0,  0}, /* 0x29 */ { 1,  0,  0,  0}, 
    /* 0x2a */ { 0,  0,  0,  0}, /* 0x2b */ {-1,  0,  0,  0}, 
    /* 0x2c */ { 0, -1,  0,  0}, /* 0x2d */ { 1, -1,  0,  0}, 
    /* 0x2e */ { 0, -1,  0,  0}, /* 0x2f */ {-1, -1,  0,  0}, 
    /* 0x30 */ { 0,  0, -1,  0}, /* 0x31 */ { 1,  0, -1,  0}, 
    /* 0x32 */ { 0,  0, -1,  0}, /* 0x33 */ {-1,  0, -1,  0}, 
    /* 0x34 */ { 0,  1, -1,  0}, /* 0x35 */ { 1,  1, -1,  0}, 
    /* 0x36 */ { 0,  1, -1,  0}, /* 0x37 */ {-1,  1, -1,  0}, 
    /* 0x38 */ { 0,  0, -1,  0}, /* 0x39 */ { 1,  0, -1,  0}, 
    /* 0x3a */ { 0,  0, -1,  0}, /* 0x3b */ {-1,  0, -1,  0}, 
    /* 0x3c */ { 0, -1, -1,  0}, /* 0x3d */ { 1, -1, -1,  0}, 
    /* 0x3e */ { 0, -1, -1,  0}, /* 0x3f */ {-1, -1, -1,  0}, 
    /* 0x40 */ { 0,  0,  0,  1}, /* 0x41 */ { 1,  0,  0,  1}, 
    /* 0x42 */ { 0,  0,  0,  1}, /* 0x43 */ {-1,  0,  0,  1}, 
    /* 0x44 */ { 0,  1,  0,  1}, /* 0x45 */ { 1,  1,  0,  1}, 
    /* 0x46 */ { 0,  1,  0,  1}, /* 0x47 */ {-1,  1,  0,  1}, 
    /* 0x48 */ { 0,  0,  0,  1}, /* 0x49 */ { 1,  0,  0,  1}, 
    /* 0x4a */ { 0,  0,  0,  1}, /* 0x4b */ {-1,  0,  0,  1}, 
    /* 0x4c */ { 0, -1,  0,  1}, /* 0x4d */ { 1, -1,  0,  1}, 
    /* 0x4e */ { 0, -1,  0,  1}, /* 0x4f */ {-1, -1,  0,  1}, 
    /* 0x50 */ { 0,  0,  1,  1}, /* 0x51 */ { 1,  0,  1,  1}, 
    /* 0x52 */ { 0,  0,  1,  1}, /* 0x53 */ {-1,  0,  1,  1}, 
    /* 0x54 */ { 0,  1,  1,  1}, /* 0x55 */ { 1,  1,  1,  1}, 
    /* 0x56 */ { 0,  1,  1,  1}, /* 0x57 */ {-1,  1,  1,  1}, 
    /* 0x58 */ { 0,  0,  1,  1}, /* 0x59 */ { 1,  0,  1,  1}, 
    /* 0x5a */ { 0,  0,  1,  1}, /* 0x5b */ {-1,  0,  1,  1}, 
    /* 0x5c */ { 0, -1,  1,  1}, /* 0x5d */ { 1, -1,  1,  1}, 
    /* 0x5e */ { 0, -1,  1,  1}, /* 0x5f */ {-1, -1,  1,  1}, 
    /* 0x60 */ { 0,  0,  0,  1}, /* 0x61 */ { 1,  0,  0,  1}, 
    /* 0x62 */ { 0,  0,  0,  1}, /* 0x63 */ {-1,  0,  0,  1}, 
    /* 0x64 */ { 0,  1,  0,  1}, /* 0x65 */ { 1,  1,  0,  1}, 
    /* 0x66 */ { 0,  1,  0,  1}, /* 0x67 */ {-1,  1,  0,  1}, 
    /* 0x68 */ { 0,  0,  0,  1}, /* 0x69 */ { 1,  0,  0,  1}, 
    /* 0x6a */ { 0,  0,  0,  1}, /* 0x6b */ {-1,  0,  0,  1}, 
    /* 0x6c */ { 0, -1,  0,  1}, /* 0x6d */ { 1, -1,  0,  1}, 
    /* 0x6e */ { 0, -1,  0,  1}, /* 0x6f */ {-1, -1,  0,  1}, 
    /* 0x70 */ { 0,  0, -1,  1}, /* 0x71 */ { 1,  0, -1,  1}, 
    /* 0x72 */ { 0,  0, -1,  1}, /* 0x73 */ {-1,  0, -1,  1}, 
    /* 0x74 */ { 0,  1, -1,  1}, /* 0x75 */ { 1,  1, -1,  1}, 
    /* 0x76 */ { 0,  1, -1,  1}, /* 0x77 */ {-1,  1, -1,  1}, 
    /* 0x78 */ { 0,  0, -1,  1}, /* 0x79 */ { 1,  0, -1,  1}, 
    /* 0x7a */ { 0,  0, -1,  1}, /* 0x7b */ {-1,  0, -1,  1}, 
    /* 0x7c */ { 0, -1, -1,  1}, /* 0x7d */ { 1, -1, -1,  1}, 
    /* 0x7e */ { 0, -1, -1,  1}, /* 0x7f */ {-1, -1, -1,  1}, 
    /* 0x80 */ { 0,  0,  0,  0}, /* 0x81 */ { 1,  0,  0,  0}, 
    /* 0x82 */ { 0,  0,  0,  0}, /* 0x83 */ {-1,  0,  0,  0}, 
    /* 0x84 */ { 0,  1,  0,  0}, /* 0x85 */ { 1,  1,  0,  0}, 
    /* 0x86 */ { 0,  1,  0,  0}, /* 0x87 */ {-1,  1,  0,  0}, 
    /* 0x88 */ { 0,  0,  0,  0}, /* 0x89 */ { 1,  0,  0,  0}, 
    /* 0x8a */ { 0,  0,  0,  0}, /* 0x8b */ {-1,  0,  0,  0}, 
    /* 0x8c */ { 0, -1,  0,  0}, /* 0x8d */ { 1, -1,  0,  0}, 
    /* 0x8e */ { 0, -1,  0,  0}, /* 0x8f */ {-1, -1,  0,  0}, 
    /* 0x90 */ { 0,  0,  1,  0}, /* 0x91 */ { 1,  0,  1,  0}, 
    /* 0x92 */ { 0,  0,  1,  0}, /* 0x93 */ {-1,  0,  1,  0}, 
    /* 0x94 */ { 0,  1,  1,  0}, /* 0x95 */ { 1,  1,  1,  0}, 
    /* 0x96 */ { 0,  1,  1,  0}, /* 0x97 */ {-1,  1,  1,  0}, 
    /* 0x98 */ { 0,  0,  1,  0}, /* 0x99 */ { 1,  0,  1,  0}, 
    /* 0x9a */ { 0,  0,  1,  0}, /* 0x9b */ {-1,  0,  1,  0}, 
    /* 0x9c */ { 0, -1,  1,  0}, /* 0x9d */ { 1, -1,  1,  0}, 
    /* 0x9e */ { 0, -1,  1,  0}, /* 0x9f */ {-1, -1,  1,  0}, 
    /* 0xa0 */ { 0,  0,  0,  0}, /* 0xa1 */ { 1,  0,  0,  0}, 
    /* 0xa2 */ { 0,  0,  0,  0}, /* 0xa3 */ {-1,  0,  0,  0}, 
    /* 0xa4 */ { 0,  1,  0,  0}, /* 0xa5 */ { 1,  1,  0,  0}, 
    /* 0xa6 */ { 0,  1,  0,  0}, /* 0xa7 */ {-1,  1,  0,  0}, 
    /* 0xa8 */ { 0,  0,  0,  0}, /* 0xa9 */ { 1,  0,  0,  0}, 
    /* 0xaa */ { 0,  0,  0,  0}, /* 0xab */ {-1,  0,  0,  0}, 
    /* 0xac */ { 0, -1,  0,  0}, /* 0xad */ { 1, -1,  0,  0}, 
    /* 0xae */ { 0, -1,  0,  0}, /* 0xaf */ {-1, -1,  0,  0}, 
    /* 0xb0 */ { 0,  0, -1,  0}, /* 0xb1 */ { 1,  0, -1,  0}, 
    /* 0xb2 */ { 0,  0, -1,  0}, /* 0xb3 */ {-1,  0, -1,  0}, 
    /* 0xb4 */ { 0,  1, -1,  0}, /* 0xb5 */ { 1,  1, -1,  0}, 
    /* 0xb6 */ { 0,  1, -1,  0}, /* 0xb7 */ {-1,  1, -1,  0}, 
    /* 0xb8 */ { 0,  0, -1,  0}, /* 0xb9 */ { 1,  0, -1,  0}, 
    /* 0xba */ { 0,  0, -1,  0}, /* 0xbb */ {-1,  0, -1,  0}, 
    /* 0xbc */ { 0, -1, -1,  0}, /* 0xbd */ { 1, -1, -1,  0}, 
    /* 0xbe */ { 0, -1, -1,  0}, /* 0xbf */ {-1, -1, -1,  0}, 
    /* 0xc0 */ { 0,  0,  0, -1}, /* 0xc1 */ { 1,  0,  0, -1}, 
    /* 0xc2 */ { 0,  0,  0, -1}, /* 0xc3 */ {-1,  0,  0, -1}, 
    /* 0xc4 */ { 0,  1,  0, -1}, /* 0xc5 */ { 1,  1,  0, -1}, 
    /* 0xc6 */ { 0,  1,  0, -1}, /* 0xc7 */ {-1,  1,  0, -1}, 
    /* 0xc8 */ { 0,  0,  0, -1}, /* 0xc9 */ { 1,  0,  0, -1}, 
    /* 0xca */ { 0,  0,  0, -1}, /* 0xcb */ {-1,  0,  0, -1}, 
    /* 0xcc */ { 0, -1,  0, -1}, /* 0xcd */ { 1, -1,  0, -1}, 
    /* 0xce */ { 0, -1,  0, -1}, /* 0xcf */ {-1, -1,  0, -1}, 
    /* 0xd0 */ { 0,  0,  1, -1}, /* 0xd1 */ { 1,  0,  1, -1}, 
    /* 0xd2 */ { 0,  0,  1, -1}, /* 0xd3 */ {-1,  0,  1, -1}, 
    /* 0xd4 */ { 0,  1,  1, -1}, /* 0xd5 */ { 1,  1,  1, -1}, 
    /* 0xd6 */ { 0,  1,  1, -1}, /* 0xd7 */ {-1,  1,  1, -1}, 
    /* 0xd8 */ { 0,  0,  1, -1}, /* 0xd9 */ { 1,  0,  1, -1}, 
    /* 0xda */ { 0,  0,  1, -1}, /* 0xdb */ {-1,  0,  1, -1}, 
    /* 0xdc */ { 0, -1,  1, -1}, /* 0xdd */ { 1, -1,  1, -1}, 
    /* 0xde */ { 0, -1,  1, -1}, /* 0xdf */ {-1, -1,  1, -1}, 
    /* 0xe0 */ { 0,  0,  0, -1}, /* 0xe1 */ { 1,  0,  0, -1}, 
    /* 0xe2 */ { 0,  0,  0, -1}, /* 0xe3 */ {-1,  0,  0, -1}, 
    /* 0xe4 */ { 0,  1,  0, -1}, /* 0xe5 */ { 1,  1,  0, -1}, 
    /* 0xe6 */ { 0,  1,  0, -1}, /* 0xe7 */ {-1,  1,  0, -1}, 
    /* 0xe8 */ { 0,  0,  0, -1}, /* 0xe9 */ { 1,  0,  0, -1}, 
    /* 0xea */ { 0,  0,  0, -1}, /* 0xeb */ {-1,  0,  0, -1}, 
    /* 0xec */ { 0, -1,  0, -1}, /* 0xed */ { 1, -1,  0, -1}, 
    /* 0xee */ { 0, -1,  0, -1}, /* 0xef */ {-1, -1,  0, -1}, 
    /* 0xf0 */ { 0,  0, -1, -1}, /* 0xf1 */ { 1,  0, -1, -1}, 
    /* 0xf2 */ { 0,  0, -1, -1}, /* 0xf3 */ {-1,  0, -1, -1}, 
    /* 0xf4 */ { 0,  1, -1, -1}, /* 0xf5 */ { 1,  1, -1, -1}, 
    /* 0xf6 */ { 0,  1, -1, -1}, /* 0xf7 */ {-1,  1, -1, -1}, 
    /* 0xf8 */ { 0,  0, -1, -1}, /* 0xf9 */ { 1,  0, -1, -1}, 
    /* 0xfa */ { 0,  0, -1, -1}, /* 0xfb */ {-1,  0, -1, -1}, 
    /* 0xfc */ { 0, -1, -1, -1}, /* 0xfd */ { 1, -1, -1, -1}, 
    /* 0xfe */ { 0, -1, -1, -1}, /* 0xff */ {-1, -1, -1, -1}, 
};
/* clang-format on */
...
static inline int32_t bitnetadd4(uint32_t activations, uint32_t weights)
{
    ...
    return ((int8_t) (activations >> 0)) * c[0] +
           ((int8_t) (activations >> 8)) * c[1] +
